       ...
       <!-- Menu lateral  -->
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				...
				<li><a href="#">Cadastrar Conteudo</a></li>
		</nav>
		<!-- Fim do menu lateral  -->       
            ...
            <div class="container" >
                    <form class="alinhamento-form">
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label" for="nome">Nome Completo</label>
                                <div class="col-sm-12">
                ...
                <input type="password" class="form-control" id="password" required/>
                            ...
                            <div class="form-group row justify-content-center alinhamento-botao">
                                <div class="col-md-4 ">
