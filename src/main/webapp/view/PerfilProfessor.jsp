...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<!-- Mostra mensagem de Erro caso a atualização de email/senha lance uma exceção OU -->
			<!-- Mostra mensagem de confirmação caso a atualização de email/senha seja efetuada -->
			<%
