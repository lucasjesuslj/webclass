...
<head>
    ...
    <title>WEBclass - Cadastro Categoria</title>
    ...
    <div class="wrapper">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                            ...
                            <li class="active">
                                <a href="telaCadastroCurso.html">Cadastrar Novo</a>
                            </li>
                        </ul>
                    </li>
                    <li >
                        <a href="telaCategoriasCoordenador.html">Categorias</a>
                    </li>
                    <li >
                            <a href="telaProfessoresCoordenador.html">professor</a>
                        </li>
            </ul>
        </nav>
        <!-- Fim do menu lateral  -->        
        ...
        <div id="content">
            ...
            <div class="container" >
                ...
                <!-- Mostra mensagem de Erro caso o cadastro de Categoria lance uma exceção OU -->
				<!-- Mostra mensagem de confirmação caso a Categoria seja cadastrado com sucesso -->
				<% 
                    ...
                    <div class="col-md-12">
                        <form action="./cadastrarCategoria" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="categoria" id="nomeCurso">
                                    </div>
                                </div>
