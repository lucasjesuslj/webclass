					...
					<form action="./cursoAtivo" method="get">
						...
						<div class="card">
							...
							<div class="row card-body justify-content-center">
								<button type="submit" class="btn btn-primary" name="codCurso" value="<%=curso.getCodCurso()%>">Acessar</button>
								<!--<a href="Curso.jsp" class="btn btn-card" name="curso" value="<%=curso.getCodCurso()%>">Acessar</a>-->
							</div>
