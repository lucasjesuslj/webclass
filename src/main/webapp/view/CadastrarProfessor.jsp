                    ...
                    <div class="col-md-12">
                        <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                            <label class="col-sm-auto col-form-label" for="atuacao">Atuação</label>
                                            <div class="col-sm-12">
                                                <input type="email" class="form-control" id="atuacao">
                                            </div>
                                        </div>
                                <div class="form-group row">
                                        <label class="col-sm-12 col-form-label" for="minibio">Mini-Bio</label>
                                    <div class="col-sm-12">
                                            <textarea class="form-control" id="minibio" rows="5"></textarea>
                                    </div>
                                </div>
